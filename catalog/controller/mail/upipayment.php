...
//
//File Path = "catalog/controller/mail/upipayment.php"
//

class ControllerMailUpiPayment extends Controller {
	public function index(&$route, &$args) {
		...
		if ($order_info) {
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
                                $comment = $this->language->get('text_email_attachment').$comment;
